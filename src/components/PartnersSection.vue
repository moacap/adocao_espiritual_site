...
const partners = [
  { name: 'Vaticano', logo: 'https://loremflickr.com/600/400/vatican,church?lock=1', link: 'https://www.vatican.va' },
  { name: 'CNBB', logo: 'https://loremflickr.com/600/400/catholic,bible?lock=2', link: 'https://www.cnbb.org.br' },
  { name: 'Arquidiocese', logo: 'https://loremflickr.com/600/400/brazil,cathedral?lock=3', link: 'https://arqrio.org' },
  { name: 'Canção Nova', logo: 'https://loremflickr.com/600/400/catholic,event?lock=4', link: 'https://www.cancaonova.com' },
  { name: 'ACI Digital', logo: 'https://loremflickr.com/600/400/pope,news?lock=5', link: 'https://www.acidigital.com' },
  { name: 'Vatican News', logo: 'https://loremflickr.com/600/400/saint,statue?lock=6', link: 'https://www.vaticannews.va' }
];
  ...
  <section class="py-40 bg-white relative overflow-hidden">
    <div class="container relative z-10">
      <div class="text-center mb-16 reveal">
        ...
        <h2 class="text-site-dark text-4xl md:text-5xl mb-6">{{ $t('partners.title') }}</h2>
        <p class="text-site-dark/70 text-lg max-w-2xl mx-auto">{{ $t('partners.description') }}</p>
      </div>
