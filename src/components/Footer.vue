  ...
  <footer class="bg-site-beige pt-24 pb-12">
    <div class="container">
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
        ...
        <!-- Links 1 -->
        <div>
          <h4 class="text-xl font-bold uppercase tracking-widest mb-8 text-site-dark">{{ $t('footer.links1.title') }}</h4>
          <ul class="space-y-4 text-site-dark/70 text-lg">
            <li><a href="#" class="hover:text-site-terracotta transition-colors">{{ $t('footer.links1.item1') }}</a></li>
            <li><a href="#" class="hover:text-site-terracotta transition-colors">{{ $t('footer.links1.item2') }}</a></li>
            <li><a href="#" class="hover:text-site-terracotta transition-colors">{{ $t('footer.links1.item3') }}</a></li>
            <li><a href="#" class="hover:text-site-terracotta transition-colors">{{ $t('footer.links1.item4') }}</a></li>
          </ul>
        </div>

        <!-- Links 2 -->
        <div>
          <h4 class="text-xl font-bold uppercase tracking-widest mb-8 text-site-dark">{{ $t('footer.links2.title') }}</h4>
          <ul class="space-y-4 text-site-dark/70 text-lg">
            <li><a href="#" class="hover:text-site-terracotta transition-colors">{{ $t('footer.links2.item1') }}</a></li>
            <li><a href="#" class="hover:text-site-terracotta transition-colors">{{ $t('footer.links2.item2') }}</a></li>
            <li><a href="#" class="hover:text-site-terracotta transition-colors">{{ $t('footer.links2.item3') }}</a></li>
            <li><a href="#" class="hover:text-site-terracotta transition-colors">{{ $t('footer.links2.item4') }}</a></li>
          </ul>
        </div>
